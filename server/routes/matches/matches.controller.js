...
exports.create = function (req, res) {
    ...
    (async () => {
        ...
        [data.date, data.place, data.tournament, data.team1.name, data.team2.name, data.team1.photo, data.team2.photo, data.summary_title, data.summary_body]);
            ...
            const insertStatsTeam1Player1Values = [data.team1.players[0].id, matchid, data.team1.name, data.team1.players[0].position, data.team1.players[0].goals, data.team1.players[0].shoots, data.team1.players[0].fouls, data.team1.players[0].assists, data.team1.players[0].score];
            ...
            const insertStatsTeam1Player2Values = [data.team1.players[1].id, matchid, data.team1.name, data.team1.players[1].position, data.team1.players[1].goals, data.team1.players[1].shoots, data.team1.players[1].fouls, data.team1.players[1].assists, data.team1.players[1].score];
            ...
            const insertStatsTeam1Player3Values = [data.team1.players[2].id, matchid, data.team1.name, data.team1.players[2].position, data.team1.players[2].goals, data.team1.players[2].shoots, data.team1.players[2].fouls, data.team1.players[2].assists, data.team1.players[2].score];
            ...
            const insertStatsTeam1Player4Values = [data.team1.players[3].id, matchid, data.team1.name, data.team1.players[3].position, data.team1.players[3].goals, data.team1.players[3].shoots, data.team1.players[3].fouls, data.team1.players[3].assists, data.team1.players[3].score];
            ...
            const insertStatsTeam1Player5Values = [data.team1.players[4].id, matchid, data.team1.name, data.team1.players[4].position, data.team1.players[4].goals, data.team1.players[4].shoots, data.team1.players[4].fouls, data.team1.players[4].assists, data.team1.players[4].score];
            ...
            const insertStatsTeam2Player1Values = [data.team2.players[0].id, matchid, data.team2.name, data.team2.players[0].position, data.team2.players[0].goals, data.team2.players[0].shoots, data.team2.players[0].fouls, data.team2.players[0].assists, data.team2.players[0].score];
            ...
            const insertStatsTeam2Player2Values = [data.team2.players[1].id, matchid, data.team2.name, data.team2.players[1].position, data.team2.players[1].goals, data.team2.players[1].shoots, data.team2.players[1].fouls, data.team2.players[1].assists, data.team2.players[1].score];
            ...
            const insertStatsTeam2Player3Values = [data.team2.players[2].id, matchid, data.team2.name, data.team2.players[2].position, data.team2.players[2].goals, data.team2.players[2].shoots, data.team2.players[2].fouls, data.team2.players[2].assists, data.team2.players[2].score];
            ...
            const insertStatsTeam2Player4Values = [data.team2.players[3].id, matchid, data.team2.name, data.team2.players[3].position, data.team2.players[3].goals, data.team2.players[3].shoots, data.team2.players[3].fouls, data.team2.players[3].assists, data.team2.players[3].score];
            ...
            const insertStatsTeam2Player5Values = [data.team2.players[4].id, matchid, data.team2.name, data.team2.players[4].position, data.team2.players[4].goals, data.team2.players[4].shoots, data.team2.players[4].fouls, data.team2.players[4].assists, data.team2.players[4].score];
