...
var FilterPlayersPipe = /** @class */ (function () {
    ...
    FilterPlayersPipe.prototype.transform = function (players, filter) {
        if (!players || !filter) {
            return players;
        }
        return players.filter(function (player) { return !filter.some(function (id) { return id === player.id; }); });
    };
